...
; Generated by writer on 4/20/2020 (UTC)
;
[Setup]
AppID={{2c1013c0-1014-47fa-ba24-80bdc1b77bc5}
AppName=ASCOM OpenAstroTracker Telescope Driver
AppVerName=ASCOM OpenAstroTracker Telescope Driver 1.0.1
AppVersion=1.0.1
...
Source: ".\OpenAstroTracker\ReadMe.htm"; DestDir: "{app}\OpenAstroTracker"; Flags: isreadme
